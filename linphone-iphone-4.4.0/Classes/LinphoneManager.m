...
NSString *const kLinphoneMsgNotificationAppGroupId = @"group.in.cryptovoip.bdl.msgNotification";//@"group.org.linphone.phone.msgNotification";
...
+ (NSString *)getUserAgent {
	return
		[NSString stringWithFormat:@"cryptovoip/%@ (cryptovoip/%s; Apple %@/%@)",
